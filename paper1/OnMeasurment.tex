...
sucessive interations. This defined a filtration on its \emph{frame pointe algebras}:
\[
...
constrain the same pointer algebra. If no such interaction has occured, their perspectives
...
\subsubsection{Comparisson table}
