...
label represents a physical distinction that can be probed in a system, that is, a question
that may be asked of the system. Measurement labels encode the primitive degrees of freedom
of the model.
%NOTE: I don't nescessarely like the talk of labels as questions. that is the role of
%the sigma algebra
...
the questions an observer may simultaneously ask of the system.
